...
class FeaturesCalculator:
    ...
    def __init__(self, trace, outstream):
        """ Constructor """
        self.trace = trace
    ...
    def __calc_ia_times(self):
        ...
        # filter out ia times > 1 second, because these are probably just user idling
    ...
    def __calc_list_information(self, lst):
        ...
        most_frequent = occurrence_count.most_common(3)
    ...
    def __collect_information(self):
        ...
        # open capture
        capture = pyshark.FileCapture(self.trace)
        ...
        for packet in capture:
            # just to make sure no undesired packets slipped through our filter (this somehow happens sometimes)
